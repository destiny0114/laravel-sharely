<div class='flex bg-white rounded-lg py-4 px-6 mb-8 shadow-md'>
    ...
    <div class='flex-1 relative'>
        <form method='POST' action="/tweets">
            ...
            <hr class="my-4" />
            @error('body')
            <p class='text-black/40 text-sm leading-none absolute left-0 bottom-0'>{{ $message }}</p>
            @enderror
            <div class="flex justify-between items-center">
                <input id="file-input" name="tweet" type="file" class="hidden" />
                ...
                <button type="submit" class='bg-blue-500 rounded-lg shadow px-4 py-2 text-white hover:bg-blue-700 focus:ring ring-blue-300 transition
